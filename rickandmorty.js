...
var getAliveHumans = function (allCharacters) {
    return allCharacters.filter(function (currentElement) { return currentElement.status === "Alive" && currentElement.species === "Human"; });
};
var characterNames = function (allCharacters) {
    return allCharacters.map(function (currentElement) { return currentElement.name; });
};
var namesAndOrigin = function (allCharacters) {
    return allCharacters.map(function (currentElement) {
